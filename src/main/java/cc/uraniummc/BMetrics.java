...
public class BMetrics {
    ...
    static {
        ...
        if (System.getProperty("bstats.relocatecheck") == null || !System.getProperty("bstats.relocatecheck").equals("false")) {
            ...
            if (BMetrics.class.getPackage().getName().equals(defaultPackage) || BMetrics.class.getPackage().getName().equals(examplePackage)) {
    ...
    public JSONObject getPluginData() {
        ...
        String pluginName = Uranium.name;
        String pluginVersion = Uranium.getCurrentVersion();
